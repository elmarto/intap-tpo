...
public class RemoteQueueInteractor {
    ...
    public RemoteQueueInteractor() throws NamingException, JMSException {
         ...
         * messaging subsystem
         */
        props.put(Context.SECURITY_PRINCIPAL, "integracion");
        props.put(Context.SECURITY_CREDENTIALS, "integracion");
        ...
        remoteQueue = (Queue) ic.lookup("jms/queue/ofertaHotel");

        remoteQueueConnection = remoteQueueCF.createConnection("integracion","integracion");
